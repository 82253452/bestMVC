<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="sequenceName" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.sequenceName}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="sequenceId" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="sequenceName" prop="sequenceName">
                    <el-input v-model="temp.sequenceName"></el-input>
                </el-form-item>
                <el-form-item label="sequenceId" prop="sequenceId">
                    <el-input v-model="temp.sequenceId"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/sysSequence'
