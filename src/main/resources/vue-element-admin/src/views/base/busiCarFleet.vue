<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="车队名称" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="地区" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.address}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="联系方式" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phone}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="负责人" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.personCharge}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="是否官方认证默认0 1是" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="负责人" prop="personCharge">
                    <el-input v-model="temp.personCharge"></el-input>
                </el-form-item>
                <el-form-item label="是否官方认证默认0 1是" prop="authentication">
                    <el-input v-model="temp.authentication"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiCarFleet'
