<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="聊天室id" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.roomId}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="答题id" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.querstionId}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="answerKey" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.answerKey}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="聊天室id" prop="roomId">
                    <el-input v-model="temp.roomId"></el-input>
                </el-form-item>
                <el-form-item label="答题id" prop="querstionId">
                    <el-input v-model="temp.querstionId"></el-input>
                </el-form-item>
                ...
                <el-form-item label="answerKey" prop="answerKey">
                    <el-input v-model="temp.answerKey"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/dataQuestionDataHistory'
