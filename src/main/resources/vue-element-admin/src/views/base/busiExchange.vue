<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="兑换类型  1、人民币换金币  2、金币换积分" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.type}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="消耗币数量" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.use}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="获得币数量" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="是否生效" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.status}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="赠送数量" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.present}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="兑换类型  1、人民币换金币  2、金币换积分" prop="type">
                    <el-input v-model="temp.type"></el-input>
                </el-form-item>
                <el-form-item label="消耗币数量" prop="use">
                    <el-input v-model="temp.use"></el-input>
                </el-form-item>
                <el-form-item label="获得币数量" prop="get">
                    <el-input v-model="temp.get"></el-input>
                </el-form-item>
                ...
                <el-form-item label="赠送数量" prop="present">
                    <el-input v-model="temp.present"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiExchange'
