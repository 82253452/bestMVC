<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="推送类型" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.type}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="推送标题" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.title}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="推送内容" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="是否强制启动应用" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.transmissionType}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="透传内容" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.transmissionContent}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="别名 空表示发送全部人" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.alias}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="是否推送完" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="是否强制启动应用" prop="transmissionType">
                    <el-input v-model="temp.transmissionType"></el-input>
                </el-form-item>
                <el-form-item label="透传内容" prop="transmissionContent">
                    <el-input v-model="temp.transmissionContent"></el-input>
                </el-form-item>
                <el-form-item label="别名 空表示发送全部人" prop="alias">
                    <el-input v-model="temp.alias"></el-input>
                </el-form-item>
                <el-form-item label="是否推送完" prop="state">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiPush'
