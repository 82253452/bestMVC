    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="subid" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.subid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="subtime" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.subtime}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="subcode" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.subcode}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="subid" prop="subid">
                    <el-input v-model="temp.subid"></el-input>
                </el-form-item>
                <el-form-item label="subtime" prop="subtime">
                    <el-input v-model="temp.subtime"></el-input>
                </el-form-item>
                <el-form-item label="subcode" prop="subcode">
                    <el-input v-model="temp.subcode"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/TConfig'
