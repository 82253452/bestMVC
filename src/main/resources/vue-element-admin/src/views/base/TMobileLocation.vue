<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="手机号前8位" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="运营商" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.isp}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="区号" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="手机号前8位" prop="phone">
                ...
                <el-form-item label="运营商" prop="isp">
                    <el-input v-model="temp.isp"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/TMobileLocation'
