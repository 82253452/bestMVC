<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="小程序模板消息ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="1 未处理  2  已处理  0 暂不处理" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.status}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="类型 1 文本 2语音" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="小程序模板消息ID" prop="formid">
                    <el-input v-model="temp.formid"></el-input>
                </el-form-item>
                ...
                <el-form-item label="1 未处理  2  已处理  0 暂不处理" prop="status">
                    <el-input v-model="temp.status"></el-input>
                </el-form-item>
                <el-form-item label="类型 1 文本 2语音" prop="type">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/sysFeedBack'
