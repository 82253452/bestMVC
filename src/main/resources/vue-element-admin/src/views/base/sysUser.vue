<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="用户信息ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="微信开放平台统一ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="状态  0：禁用   1：正常" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.status}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="创建者ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="最后登陆时间" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="用户信息ID" prop="uid">
                ...
                <el-form-item label="微信开放平台统一ID" prop="unionid">
                    <el-input v-model="temp.unionid"></el-input>
                </el-form-item>
                ...
                <el-form-item label="最后登陆时间" prop="lastLogin">
                    <el-input v-model="temp.lastLogin"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/sysUser'
