<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="连续签到天数" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.num}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="最后签到时间" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.lastSign}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="连续签到天数" prop="num">
                    <el-input v-model="temp.num"></el-input>
                </el-form-item>
                <el-form-item label="最后签到时间" prop="lastSign">
                    <el-input v-model="temp.lastSign"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/sysUserSign'
