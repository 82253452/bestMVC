    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="选项" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.answerOptions}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="难度" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="选项" prop="answerOptions">
                    <el-input v-model="temp.answerOptions"></el-input>
                </el-form-item>
                <el-form-item label="难度" prop="difficulty">
                    <el-input v-model="temp.difficulty"></el-input>
                </el-form-item>
                <el-form-item label="正确答案" prop="rightKey">
                    <el-input v-model="temp.rightKey"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/dataQuestions'
