    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="ruleid" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.ruleid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="order" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.order}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="round" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.round}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="rounddes" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.rounddes}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="ruleid" prop="ruleid">
                    <el-input v-model="temp.ruleid"></el-input>
                </el-form-item>
                <el-form-item label="order" prop="order">
                    <el-input v-model="temp.order"></el-input>
                </el-form-item>
                <el-form-item label="round" prop="round">
                    <el-input v-model="temp.round"></el-input>
                </el-form-item>
                <el-form-item label="rounddes" prop="rounddes">
                    <el-input v-model="temp.rounddes"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/TPositionruledes'
