<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="类型  1 积分   2  金币   3 现金" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="消费" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.amount}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="运费   0  包邮   " width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.freight}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="收件人" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="状态   1" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="类型  1 积分   2  金币   3 现金" prop="type">
                ...
                <el-form-item label="运费   0  包邮   " prop="freight">
                    <el-input v-model="temp.freight"></el-input>
                </el-form-item>
                <el-form-item label="收件人" prop="consignee">
                    <el-input v-model="temp.consignee"></el-input>
                </el-form-item>
                ...
                <el-form-item label="状态   1" prop="status">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiExchageRecord'
