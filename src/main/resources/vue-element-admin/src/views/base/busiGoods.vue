<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="成本" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="积分" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.ponits}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="赞助商" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.sponsor}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="库存" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.stock}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="状态   1 上架  0 下架" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="消费方式 1 积分支付  2 金币支付  0 金币和积分都支持" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.type}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="金币" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.gold}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="赠送积分" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.largess}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="成本" prop="cost">
                    <el-input v-model="temp.cost"></el-input>
                </el-form-item>
                <el-form-item label="积分" prop="ponits">
                    <el-input v-model="temp.ponits"></el-input>
                </el-form-item>
                <el-form-item label="赞助商" prop="sponsor">
                    <el-input v-model="temp.sponsor"></el-input>
                </el-form-item>
                ...
                <el-form-item label="创建人" prop="creator">
                    <el-input v-model="temp.creator"></el-input>
                </el-form-item>
                <el-form-item label="消费方式 1 积分支付  2 金币支付  0 金币和积分都支持" prop="type">
                    <el-input v-model="temp.type"></el-input>
                </el-form-item>
                <el-form-item label="金币" prop="gold">
                    <el-input v-model="temp.gold"></el-input>
                </el-form-item>
                <el-form-item label="赠送积分" prop="largess">
                    <el-input v-model="temp.largess"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiGoods'
