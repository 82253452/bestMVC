<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="活动说明介绍" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.content}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="分享活动介绍" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="是否可用" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.isUsable}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="活动说明介绍" prop="content">
                    <el-input v-model="temp.content"></el-input>
                </el-form-item>
                <el-form-item label="分享活动介绍" prop="shareContent">
                    <el-input v-model="temp.shareContent"></el-input>
                </el-form-item>
                <el-form-item label="是否显示" prop="isShow">
                    <el-input v-model="temp.isShow"></el-input>
                </el-form-item>
                <el-form-item label="是否可用" prop="isUsable">
                    <el-input v-model="temp.isUsable"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/gameTurntableInfo'
