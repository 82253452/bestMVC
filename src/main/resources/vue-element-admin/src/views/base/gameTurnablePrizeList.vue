<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="奖品图片" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.img}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="链接地址" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.linkUrl}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="奖品说明" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="probability" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.probability}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="sort" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.sort}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="num" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="奖品说明" prop="content">
                    <el-input v-model="temp.content"></el-input>
                </el-form-item>
                <el-form-item label="活动id" prop="infoId">
                    <el-input v-model="temp.infoId"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/gameTurnablePrizeList'
