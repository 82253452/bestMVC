<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="类型 0 建议 1 回复" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.type}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="状态 默认0 已读1" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="建议标题" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.title}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="images" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.images}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="pid" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="状态 0 失败 1成功" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="类型 0 建议 1 回复" prop="type">
                    <el-input v-model="temp.type"></el-input>
                </el-form-item>
                <el-form-item label="状态 默认0 已读1" prop="status">
                ...
                <el-form-item label="images" prop="images">
                    <el-input v-model="temp.images"></el-input>
                </el-form-item>
                ...
                <el-form-item label="状态 0 失败 1成功" prop="cstatus">
                    <el-input v-model="temp.cstatus"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiSuggestion'
