<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="订单表id" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="支付类型(信用卡支付、现金支付、支票支付)" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.paymentMethodType}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="支付金额" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="thirdNo" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.thirdNo}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="totalFee" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.totalFee}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="paymentTime" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="支付方式" prop="paymentMethod">
                    <el-input v-model="temp.paymentMethod"></el-input>
                </el-form-item>
                <el-form-item label="支付类型(信用卡支付、现金支付、支票支付)" prop="paymentMethodType">
                    <el-input v-model="temp.paymentMethodType"></el-input>
                </el-form-item>
                ...
                <el-form-item label="thirdNo" prop="thirdNo">
                    <el-input v-model="temp.thirdNo"></el-input>
                </el-form-item>
                <el-form-item label="totalFee" prop="totalFee">
                    <el-input v-model="temp.totalFee"></el-input>
                </el-form-item>
                <el-form-item label="paymentTime" prop="paymentTime">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiPayment'
