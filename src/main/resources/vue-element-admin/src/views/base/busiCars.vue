<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="车主" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="品牌logo" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.logoImg}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="扭矩" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.torque}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="状态 默认0 1 审核中 2审核通过 3不通过" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.status}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="driveImg" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.driveImg}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="扭矩" prop="torque">
                    <el-input v-model="temp.torque"></el-input>
                </el-form-item>
                ...
                <el-form-item label="状态 默认0 1 审核中 2审核通过 3不通过" prop="status">
                    <el-input v-model="temp.status"></el-input>
                </el-form-item>
                <el-form-item label="driveImg" prop="driveImg">
                    <el-input v-model="temp.driveImg"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiCars'
