<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="可用次数" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.availableNumber}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="分享到群次数" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.shareGroupNumber}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="分享次数" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.shareNumber}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="用户状态" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.state}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="createTime" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.createTime}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="updateTime" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="可用次数" prop="availableNumber">
                    <el-input v-model="temp.availableNumber"></el-input>
                </el-form-item>
                <el-form-item label="分享到群次数" prop="shareGroupNumber">
                    <el-input v-model="temp.shareGroupNumber"></el-input>
                </el-form-item>
                <el-form-item label="分享次数" prop="shareNumber">
                    <el-input v-model="temp.shareNumber"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/gameTurntableUser'
