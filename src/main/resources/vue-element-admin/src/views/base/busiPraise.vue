<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="成绩ID" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.resultid}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="赛事ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="状态  0 失效  1 生效" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.status}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="0 默认 1文章点赞 2文章收藏" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="成绩ID" prop="resultid">
                    <el-input v-model="temp.resultid"></el-input>
                </el-form-item>
                ...
                <el-form-item label="赛事ID" prop="sportid">
                    <el-input v-model="temp.sportid"></el-input>
                </el-form-item>
                <el-form-item label="修改时间" prop="mtine">
                    <el-input v-model="temp.mtine"></el-input>
                </el-form-item>
                <el-form-item label="创建时间" prop="ctime">
                    <el-input v-model="temp.ctime"></el-input>
                </el-form-item>
                <el-form-item label="状态  0 失效  1 生效" prop="status">
                    <el-input v-model="temp.status"></el-input>
                </el-form-item>
                <el-form-item label="0 默认 1文章点赞 2文章收藏" prop="type">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiPraise'
