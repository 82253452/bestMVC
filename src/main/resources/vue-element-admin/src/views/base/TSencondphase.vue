    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="组号" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.组号}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="车号姓名" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.车号姓名}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="组号" prop="组号">
                    <el-input v-model="temp.组号"></el-input>
                </el-form-item>
                <el-form-item label="名次" prop="名次">
                    <el-input v-model="temp.名次"></el-input>
                </el-form-item>
                <el-form-item label="车号姓名" prop="车号姓名">
                    <el-input v-model="temp.车号姓名"></el-input>
                </el-form-item>
                <el-form-item label="时间" prop="时间">
                    <el-input v-model="temp.时间"></el-input>
                </el-form-item>
                <el-form-item label="尾速" prop="尾速">
                    <el-input v-model="temp.尾速"></el-input>
                </el-form-item>
                <el-form-item label="车号" prop="车号">
                    <el-input v-model="temp.车号"></el-input>
                </el-form-item>
                <el-form-item label="姓名" prop="姓名">
                    <el-input v-model="temp.姓名"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/TSencondphase'
