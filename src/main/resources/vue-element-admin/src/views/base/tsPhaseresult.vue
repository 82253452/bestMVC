    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="phaseid" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phaseid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="phaseresultorder" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phaseresultorder}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="phaseid" prop="phaseid">
                    <el-input v-model="temp.phaseid"></el-input>
                </el-form-item>
                <el-form-item label="phaseresultorder" prop="phaseresultorder">
                    <el-input v-model="temp.phaseresultorder"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/tsPhaseresult'
