<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="状态   0：隐藏   1：显示" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="Value值类型    1 文本  2 图片 3 编辑器" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="Value值类型    1 文本  2 图片 3 编辑器" prop="type">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/sysConfig'
