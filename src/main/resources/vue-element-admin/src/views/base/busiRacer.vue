<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="关联用户ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="是否认证" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.certification}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="区域" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.area}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="当前车队" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.serve}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="曾效力于" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.served}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="车量类型" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="mtine" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="生日" prop="birthday">
                    <el-input v-model="temp.birthday"></el-input>
                </el-form-item>
                ...
                <el-form-item label="证件类型" prop="certtype">
                    <el-input v-model="temp.certtype"></el-input>
                </el-form-item>
                <el-form-item label="证件号码" prop="certno">
                    <el-input v-model="temp.certno"></el-input>
                </el-form-item>
                <el-form-item label="是否认证" prop="certification">
                    <el-input v-model="temp.certification"></el-input>
                </el-form-item>
                ...
                <el-form-item label="当前车队" prop="serve">
                    <el-input v-model="temp.serve"></el-input>
                </el-form-item>
                <el-form-item label="曾效力于" prop="served">
                    <el-input v-model="temp.served"></el-input>
                </el-form-item>
                <el-form-item label="车量类型" prop="cartype">
                    <el-input v-model="temp.cartype"></el-input>
                </el-form-item>
                ...
                <el-form-item label="mtine" prop="mtine">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiRacer'
