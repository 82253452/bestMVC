    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="phaseid" fixed="left" width="65">
                <template slot-scope="scope">
                   <span>{{scope.row.phaseid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="fatherphaseid" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="phaseorder" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phaseorder}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="phasetype" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phasetype}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="phasecode" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phasecode}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="phaselongname" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.phaselongname}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="phaseshortname" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="fatherphaseid" prop="fatherphaseid">
                ...
                <el-form-item label="phaseorder" prop="phaseorder">
                ...
                <el-form-item label="phasecode" prop="phasecode">
                    <el-input v-model="temp.phasecode"></el-input>
                </el-form-item>
                <el-form-item label="phaselongname" prop="phaselongname">
                    <el-input v-model="temp.phaselongname"></el-input>
                </el-form-item>
                <el-form-item label="phaseshortname" prop="phaseshortname">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/tsPhase'
