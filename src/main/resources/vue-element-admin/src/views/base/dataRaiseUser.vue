<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="被助力人id" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.uid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="助力人员json" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.userData}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="被助力人id" prop="uid">
                    <el-input v-model="temp.uid"></el-input>
                </el-form-item>
                <el-form-item label="助力人员json" prop="userData">
                    <el-input v-model="temp.userData"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/dataRaiseUser'
