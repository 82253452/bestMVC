<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="时间的数字转换" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.timesInt}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="生效状态" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="时间的数字转换" prop="timesInt">
                    <el-input v-model="temp.timesInt"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/gameReaction'
