<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="阶段名称" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.scheduleItemName}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="阶段标识" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.nodeTypeDes}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="父阶段" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="节点级别" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.nodeLevel}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="节点排序" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.itemOrder}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="节点Key" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.nodeKey}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="父节点Key" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.fatherNodeKey}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="阶段名称" prop="scheduleItemName">
                    <el-input v-model="temp.scheduleItemName"></el-input>
                </el-form-item>
                <el-form-item label="阶段标识" prop="nodeTypeDes">
                    <el-input v-model="temp.nodeTypeDes"></el-input>
                </el-form-item>
                ...
                <el-form-item label="阶段类型" prop="phasecode">
                    <el-input v-model="temp.phasecode"></el-input>
                </el-form-item>
                <el-form-item label="父阶段" prop="fatherphaseid">
                    <el-input v-model="temp.fatherphaseid"></el-input>
                </el-form-item>
                <el-form-item label="比赛ID" prop="matchid">
                    <el-input v-model="temp.matchid"></el-input>
                </el-form-item>
                <el-form-item label="节点级别" prop="nodeLevel">
                    <el-input v-model="temp.nodeLevel"></el-input>
                </el-form-item>
                <el-form-item label="节点排序" prop="itemOrder">
                    <el-input v-model="temp.itemOrder"></el-input>
                </el-form-item>
                <el-form-item label="节点Key" prop="nodeKey">
                    <el-input v-model="temp.nodeKey"></el-input>
                </el-form-item>
                <el-form-item label="父节点Key" prop="fatherNodeKey">
                    <el-input v-model="temp.fatherNodeKey"></el-input>
                </el-form-item>
                <el-form-item label="创建时间" prop="ctime">
                    <el-input v-model="temp.ctime"></el-input>
                </el-form-item>
                <el-form-item label="最后修改时间" prop="mtine">
                    <el-input v-model="temp.mtine"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiSchedule'
