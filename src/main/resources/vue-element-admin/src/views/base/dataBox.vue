<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="速度" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.speed}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="坡度" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.height}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="加速度" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.acceleration}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="距离" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.distance}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="总用时" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.time}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="类型 1 0-400" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.type}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="平均G值" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.accelerationAvg}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="尾速" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.speedTail}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="device" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="坡度" prop="height">
                    <el-input v-model="temp.height"></el-input>
                </el-form-item>
                <el-form-item label="加速度" prop="acceleration">
                    <el-input v-model="temp.acceleration"></el-input>
                </el-form-item>
                <el-form-item label="距离" prop="distance">
                    <el-input v-model="temp.distance"></el-input>
                </el-form-item>
                <el-form-item label="总用时" prop="time">
                    <el-input v-model="temp.time"></el-input>
                </el-form-item>
                <el-form-item label="类型 1 0-400" prop="type">
                    <el-input v-model="temp.type"></el-input>
                </el-form-item>
                <el-form-item label="平均G值" prop="accelerationAvg">
                    <el-input v-model="temp.accelerationAvg"></el-input>
                </el-form-item>
                <el-form-item label="尾速" prop="speedTail">
                    <el-input v-model="temp.speedTail"></el-input>
                </el-form-item>
                <el-form-item label="device" prop="device">
                    <el-input v-model="temp.device"></el-input>
                </el-form-item>
                <el-form-item label="设备号" prop="deviceCode">
                    <el-input v-model="temp.deviceCode"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/dataBox'
