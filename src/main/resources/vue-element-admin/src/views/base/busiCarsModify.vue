<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="图片路径" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.img}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="改装类型" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.mtype}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="改装类型名称" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.mtypeName}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="类型 0 图集 1 改装" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="改装类型" prop="mtype">
                    <el-input v-model="temp.mtype"></el-input>
                </el-form-item>
                <el-form-item label="改装类型名称" prop="mtypeName">
                    <el-input v-model="temp.mtypeName"></el-input>
                </el-form-item>
                ...
                <el-form-item label="类型 0 图集 1 改装" prop="type">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiCarsModify'
