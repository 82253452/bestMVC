<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="matchcode" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.matchcode}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="matchno" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.matchno}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="matchlongname" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.matchlongname}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="matchshortname" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.matchshortname}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="matchorder" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.matchorder}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="matchstatus" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="matchcode" prop="matchcode">
                    <el-input v-model="temp.matchcode"></el-input>
                </el-form-item>
                <el-form-item label="matchno" prop="matchno">
                    <el-input v-model="temp.matchno"></el-input>
                </el-form-item>
                <el-form-item label="matchlongname" prop="matchlongname">
                    <el-input v-model="temp.matchlongname"></el-input>
                </el-form-item>
                <el-form-item label="matchshortname" prop="matchshortname">
                    <el-input v-model="temp.matchshortname"></el-input>
                </el-form-item>
                <el-form-item label="matchorder" prop="matchorder">
                    <el-input v-model="temp.matchorder"></el-input>
                </el-form-item>
                <el-form-item label="matchstatus" prop="matchstatus">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/tsMatch'
