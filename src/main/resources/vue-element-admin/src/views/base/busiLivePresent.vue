<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="礼物图片" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.img}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="小图片" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.logo}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="积分值" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="礼物名称" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.name}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="效果
1、大效果
2、小效果" width="150">
                <template slot-scope="scope">
...
2、小效果" prop="type">
                ...
                <el-form-item label="支付方式" prop="payment">
                    <el-input v-model="temp.payment"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiLivePresent'
