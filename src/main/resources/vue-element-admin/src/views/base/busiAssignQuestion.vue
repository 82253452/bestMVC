<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="题库id" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.questionId}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="类型 0 积分" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="状态 默认0 1开始答题  2 发布答案" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="题库id" prop="questionId">
                    <el-input v-model="temp.questionId"></el-input>
                </el-form-item>
                <el-form-item label="类型 0 积分" prop="type">
                    <el-input v-model="temp.type"></el-input>
                </el-form-item>
                <el-form-item label="数量" prop="total">
                    <el-input v-model="temp.total"></el-input>
                </el-form-item>
                <el-form-item label="状态 默认0 1开始答题  2 发布答案" prop="status">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiAssignQuestion'
