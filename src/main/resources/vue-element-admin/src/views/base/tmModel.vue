<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="fModelname" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.fModelname}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="fModelcomment" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.fModelcomment}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="fModelname" prop="fModelname">
                    <el-input v-model="temp.fModelname"></el-input>
                </el-form-item>
                <el-form-item label="fModelcomment" prop="fModelcomment">
                    <el-input v-model="temp.fModelcomment"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/tmModel'
