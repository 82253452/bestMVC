<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="赛手ID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="护照号码" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.passport}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="微信" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="场地" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="进气模式" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.intakemodel}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="驱动形式" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.drivemodel}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="赛手ID" prop="rid">
                    <el-input v-model="temp.rid"></el-input>
                </el-form-item>
                ...
                <el-form-item label="进气模式" prop="intakemodel">
                    <el-input v-model="temp.intakemodel"></el-input>
                </el-form-item>
                <el-form-item label="驱动形式" prop="drivemodel">
                    <el-input v-model="temp.drivemodel"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiEnrollCopy1'
