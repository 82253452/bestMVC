<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="俱乐部的封面" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.cover}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="1 开放申请  0 关闭申请" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.apply}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="0 不限制人数" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.toplimit}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="总成员数" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.number}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="俱乐部地址" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.addr}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="管理员的UID" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.manager}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="创建人的UID" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="1 生效  2 解散" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="俱乐部的封面" prop="cover">
                    <el-input v-model="temp.cover"></el-input>
                </el-form-item>
                <el-form-item label="1 开放申请  0 关闭申请" prop="apply">
                    <el-input v-model="temp.apply"></el-input>
                </el-form-item>
                <el-form-item label="0 不限制人数" prop="toplimit">
                    <el-input v-model="temp.toplimit"></el-input>
                </el-form-item>
                <el-form-item label="总成员数" prop="number">
                    <el-input v-model="temp.number"></el-input>
                </el-form-item>
                <el-form-item label="俱乐部地址" prop="addr">
                    <el-input v-model="temp.addr"></el-input>
                </el-form-item>
                <el-form-item label="管理员的UID" prop="manager">
                    <el-input v-model="temp.manager"></el-input>
                </el-form-item>
                <el-form-item label="创建人的UID" prop="uid">
                    <el-input v-model="temp.uid"></el-input>
                </el-form-item>
                <el-form-item label="创建时间" prop="ctime">
                    <el-input v-model="temp.ctime"></el-input>
                </el-form-item>
                <el-form-item label="1 生效  2 解散" prop="status">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiClub'
