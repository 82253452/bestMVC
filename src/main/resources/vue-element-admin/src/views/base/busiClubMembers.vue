    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="主键id" width="150">
            ...
            <el-table-column align="center" label="1 群主  2 普通会员" width="150">
                <template slot-scope="scope">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiClubMembers'
