<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="首字母" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.letter}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="值" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.text}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="父节点" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.parentid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="类型 1 国家 2省份 3地市" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.type}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="热门城市" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="首字母" prop="letter">
                    <el-input v-model="temp.letter"></el-input>
                </el-form-item>
                <el-form-item label="值" prop="text">
                    <el-input v-model="temp.text"></el-input>
                </el-form-item>
                <el-form-item label="父节点" prop="parentid">
                    <el-input v-model="temp.parentid"></el-input>
                </el-form-item>
                <el-form-item label="类型 1 国家 2省份 3地市" prop="type">
                    <el-input v-model="temp.type"></el-input>
                </el-form-item>
                <el-form-item label="热门城市" prop="hot">
                    <el-input v-model="temp.hot"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/sysArea'
