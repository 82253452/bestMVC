<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="黑名单" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.blacklistint}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="禁言" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.forbidlist}}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="黑名单" prop="blacklistint">
                    <el-input v-model="temp.blacklistint"></el-input>
                </el-form-item>
                <el-form-item label="禁言" prop="forbidlist">
                    <el-input v-model="temp.forbidlist"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiLiveUsers'
