    ...
    <div class="app-container">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="竞猜ID" prop="drawId">
                    <el-input v-model="temp.drawId"></el-input>
                </el-form-item>
                <el-form-item label="赛手ID" prop="racerid">
                    <el-input v-model="temp.racerid"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiDrawPraise'
