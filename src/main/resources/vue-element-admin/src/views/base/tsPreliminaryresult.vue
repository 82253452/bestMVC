    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="autoid" fixed="left" width="65">
                <template slot-scope="scope">
                   <span>{{scope.row.autoid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="resulttime" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="matchid" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="userno" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="resulttime" prop="resulttime">
                    <el-input v-model="temp.resulttime"></el-input>
                </el-form-item>
                ...
                <el-form-item label="userno" prop="userno">
                    <el-input v-model="temp.userno"></el-input>
                </el-form-item>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/tsPreliminaryresult'
