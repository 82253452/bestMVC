<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="奖品id" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="infoId" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="奖品id" prop="prizeId">
                    <el-input v-model="temp.prizeId"></el-input>
                </el-form-item>
                ...
                <el-form-item label="infoId" prop="infoId">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/gameTurnableUserPrize'
