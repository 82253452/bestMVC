    ...
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
                  style="width: 100%;min-height:500px;">
                        <el-table-column align="center" label="statusid" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.statusid}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="statuscode" width="150">
                <template slot-scope="scope">
                    <span>{{scope.row.statuscode}}</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="statusname" width="150">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px"
                ...
                <el-form-item label="statusid" prop="statusid">
                    <el-input v-model="temp.statusid"></el-input>
                </el-form-item>
                <el-form-item label="statuscode" prop="statuscode">
                    <el-input v-model="temp.statuscode"></el-input>
                </el-form-item>
                <el-form-item label="statusname" prop="statusname">
                    <el-input v-model="temp.statusname"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/tcStatus'
