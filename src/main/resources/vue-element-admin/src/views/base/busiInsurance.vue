<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="保险名称" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="保险描述" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="保险公司联系电话" width="150">
                <template slot-scope="scope">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/busiInsurance'
