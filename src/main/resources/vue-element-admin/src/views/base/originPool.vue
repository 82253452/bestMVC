<template>
    <div class="app-container">
        ...
        <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="建议的类型" width="150">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="建议者UID" width="150">
                <template slot-scope="scope">
...
<script>
    import {selectByPage, insert, selectById, updateById, deleteById} from '@/api/base/originPool'
