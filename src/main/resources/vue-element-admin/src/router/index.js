...
export const asyncRouterMap = [
  {
    ...
    children: [{
      path: 'tsSport',
      component: () => import('@/views/base/tsSport'),
      name: 'tsSport',
      meta: {title: '比赛管理', icon: 'icon', noCache: true}
    },
      {
        path: 'tcType',
        component: () => import('@/views/base/tcType'),
        name: 'tcType',
        meta: {title: '比赛规则', icon: 'icon', noCache: true}
      },
      {
        path: 'busiEnrollUp',
        component: () => import('@/views/base/busiEnrollUp'),
        name: 'busiEnrollUp',
        meta: {title: '报名人员管理', icon: 'icon', noCache: true}
      },
    ]
  },
  {
    ...
    children: [{
      ...
      name: 'test',
      meta: {title: '排位赛', icon: 'icon', noCache: true}
    },
      {
        path: 'test2',
        component: () => import('@/views/test/index2'),
        name: 'test2',
        meta: {title: '淘汰赛', icon: 'icon', noCache: true}
      },
    ]
  },
